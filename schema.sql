-- ============================================================
-- SCHEMA CLOUDFLARE D1 (SQLITE) - WEBSITE KUA KECAMATAN NANGGUNG
-- ============================================================
...
CREATE TABLE IF NOT EXISTS pegawai (
  ...
  avatar TEXT,
  bio TEXT,
  keahlian TEXT, -- Disimpan dalam format JSON array string: ["Keahlian 1", "Keahlian 2"]
  email TEXT,
  hp TEXT,
...
-- 3. TABEL SETTINGS / KONFIGURASI SITUS
...
-- SEED DATA AWAL PEGAWAI KUA KECAMATAN NANGGUNG
INSERT OR IGNORE INTO pegawai (id, nama, role, nip, jabatan, wilayah, avatar, bio, keahlian, email, hp, urutan) VALUES
